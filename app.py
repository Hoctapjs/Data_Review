...
TITLE_TEMPLATES = {
    "Positive": [
        ...
        "Cannot get over how {adj1} these are","Looks just like my real hair",
"The blend is amazing",
"Best U Part Wig I've owned",
"Nobody knew it was a wig",
"So natural looking",
...
BODY_BANK = {
    "Positive": {
        "opener": [
    "I've been looking for a good U Part Wig for months and finally decided to try this one.",
    "This was actually my first U Part Wig and I was a little nervous ordering online.",
    "I wanted something that looked natural without dealing with lace every day.",
    "I've been wearing sew-ins for years and wanted a break from salon appointments.",
    "After some hair thinning around my crown, I wanted a little extra fullness.",
    "I bought this because I needed a quick hairstyle for work.",
    "I've been trying to protect my natural hair from daily heat styling.",
    "I wanted something beginner friendly and easy to install.",
    "My natural hair is shoulder length and I wanted a little more length.",
    "I needed something that looked professional but still natural.",
    "I bought this before a wedding and I'm so glad I did.",
    "I've tried several wigs before but this one immediately stood out.",
    "I wanted a protective style that still felt like my own hair.",
    "I was tired of glue and lace maintenance so I decided to try a U Part Wig.",
    "I normally wear lace wigs but wanted something faster for everyday wear."
],
        "quality": [
    ...
    "The straight texture looks very realistic.",
    "The density feels natural and not overly bulky.",
    "The wig feels lightweight but still looks full.",
    "The hair moves naturally when I walk.",
    "There was very little shedding when I brushed it.",
    "The ends are nice and full.",
    "The quality honestly surprised me.",
    "It looks much more expensive than it actually is.",
    "The strands stay soft even after washing.",
    "The hair straightens beautifully.",
    ...
    "People genuinely thought it was my real hair.",
    "My confidence instantly went up.",
    "I've worn it almost every day since it arrived.",
    "This has become my go-to hairstyle.",
    "I finally found a wig that feels natural.",
    "It photographs beautifully.",
    "The natural look is exactly what I wanted.",
    "I've already recommended it to my sister.",
    "This is easily one of the best wigs I've purchased.",
    "Even in bright sunlight it still looks natural.",
    "I already ordered another one in a different length."       
        ],
        "value": [
