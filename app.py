...
BODY_BANK = {
    "Positive": {
        "opener": [
   "I've been looking for a natural everyday wig and decided to give this one a try.",
    "After reading several reviews, I finally ordered this wig.",
    "I wanted something that looked natural without spending hours styling my hair.",
    "I've worn different wigs over the years and this one really stood out.",
    "I purchased this mainly for everyday wear and I'm glad I did.",
    "I wanted a style that looked polished but still natural.",
    "I've been trying to find a wig that blends well with my own hair.",
    "This was my first hand tied U Part Wig and I was pleasantly surprised.",
    "I was looking for something lightweight and comfortable for daily use.",
    "I wanted a protective style that still looked like my own hair.",
    "I bought this before a special event and ended up wearing it much more often.",
    "I've been trying different wigs lately and this one has become a favorite.",
    "I needed something easy to wear for work and everyday activities.",
    "I was mainly looking for comfort and a natural appearance.",
    "I wasn't sure what to expect, but the quality impressed me."
],
        "quality": [
    "The hair feels incredibly soft and smooth.",
    "The straight texture looks very natural.",
    "The hand tied construction feels lightweight and comfortable.",
    "The hair moves naturally and doesn't look stiff.",
    "The quality exceeded my expectations.",
    "The wig lays very flat and looks realistic.",
    "The density feels natural for everyday wear.",
    "The hair remains soft throughout the day.",
    "The strands have a healthy natural appearance.",
    "The wig feels well made and durable.",
    "The hair brushes easily and doesn't tangle much.",
    "The construction feels secure without being bulky.",
    "The texture looks realistic in person.",
    "The hair has beautiful natural movement.",
    "It looks much more expensive than it actually is."
        ],
        "color": [
    "The color matched the product photos really well.",
    "The shade looked very similar to what I saw online.",
    "I was happy with how accurate the color appeared.",
    "The color blended naturally with my own hair.",
    "The shade looked realistic in different lighting.",
    "The color was true to the listing photos.",
    "I was pleasantly surprised by how accurate the color was.",
    "The tone worked really well for me.",
    "The color looked natural once installed.",
    "I had no issues getting it to blend.",
    "The shade looked even better in person.",
    "The color matched my expectations.",
    "The tone looked very natural.",
    "The color blended seamlessly.",
    "The shade worked surprisingly well with my hair."
],
        "fit_usage": [
    "Installation was quick and straightforward.",
    "I had it ready to wear in just a few minutes.",
    "The clips felt secure throughout the day.",
    "It stayed in place without any issues.",
    "The cap felt comfortable even after several hours.",
    "I didn't need any glue or complicated styling.",
    "Getting ready in the morning became much easier.",
    "It was surprisingly beginner friendly.",
    "The wig sits flat and feels secure.",
    "It takes very little effort to make it look natural.",
    "I can wear it comfortably all day.",
    "The construction makes it easy to put on and remove."
],
        "results": [
    ...
    "A few people thought it was my natural hair.",
    "Nobody realized I was wearing a wig.",
    "I've worn it many times already.",
    "It has become part of my regular routine.",
    "The style photographs beautifully.",
    "I find myself reaching for this wig often.",
    "It blends really well with my natural hair.",
    "The style works for both casual and formal occasions.",
    "I've been very pleased with how natural it looks.",
    "It looks great both indoors and outdoors.",
    "Several friends asked where I got it.",
    "This has become one of my favorite wigs.",
    "The natural appearance is exactly what I wanted." 
        ],
        "value": [
    ...
    "This will stay in my regular rotation.",
